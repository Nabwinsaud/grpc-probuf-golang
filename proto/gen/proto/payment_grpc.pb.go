...
type PaymentServiceClient interface {
	...
	GetPayment(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*PaymentList, error)
	UpdatePayment(ctx context.Context, in *PaymentResponse, opts ...grpc.CallOption) (*PaymentResponse, error)
...
func (c *paymentServiceClient) GetPayment(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*PaymentList, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PaymentList)
...
func (c *paymentServiceClient) UpdatePayment(ctx context.Context, in *PaymentResponse, opts ...grpc.CallOption) (*PaymentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PaymentResponse)
...
type PaymentServiceServer interface {
	...
	GetPayment(context.Context, *Empty) (*PaymentList, error)
	UpdatePayment(context.Context, *PaymentResponse) (*PaymentResponse, error)
...
func (UnimplementedPaymentServiceServer) GetPayment(context.Context, *Empty) (*PaymentList, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPayment not implemented")
}
func (UnimplementedPaymentServiceServer) UpdatePayment(context.Context, *PaymentResponse) (*PaymentResponse, error) {
...
func _PaymentService_GetPayment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).GetPayment(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _PaymentService_UpdatePayment_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).UpdatePayment(ctx, req.(*PaymentResponse))
	}
	return interceptor(ctx, in, info, handler)
}
